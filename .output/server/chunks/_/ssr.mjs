...
import { createRootRouteWithContext, Outlet, HeadContent, Scripts, useRouterState, createFileRoute, lazyRouteComponent, RouterProvider, Link, useRouter, useMatch, rootRouteId, ErrorComponent, createRouter as createRouter$1 } from '@tanstack/react-router';
import { notifyManager, QueryClient, MutationCache, QueryClientProvider } from '@tanstack/react-query';
...
import { joinPaths, trimPath, processRouteTree, isRedirect, isResolvedRedirect, isNotFound, rootRouteId as rootRouteId$1, getMatchedRoutes, isPlainObject } from '@tanstack/router-core';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-DbxR6a78.mjs');
...
function Loader() {
  return /* @__PURE__ */ jsx("div", { className: "flex h-full", children: /* @__PURE__ */ jsx("div", { className: "m-auto border-gray-300 h-20 max-h-full aspect-square animate-spin rounded-full border-8 border-t-slate-900" }) });
}
...
const appCss = "/assets/app-BH7av6lu.css";
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxs("body", { children: [
      /* @__PURE__ */ jsx("div", { className: "root h-screen flex flex-col min-h-0", children: /* @__PURE__ */ jsxs("div", { className: "border-b border-slate-800 flex items-center justify-between py-4 px-8 box-border", children: [
        /* @__PURE__ */ jsx(LoadingIndicator, {}),
        /* @__PURE__ */ jsxs("div", { className: "flex-grow min-h-0 h-full flex flex-col", children: [
          children,
...
const $$splitComponentImporter$1 = () => import('./signin-CF2K6t0r.mjs');
const Route$1 = createFileRoute("/signin")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./index-mN5q1hxb.mjs');
...
function createRouter() {
  ...
  const router = createRouter$1({
    ...
    context: { queryClient },
    Wrap: ({ children }) => /* @__PURE__ */ jsx(ConvexAuthProvider, { client: convexQueryClient.convexClient, children }),
