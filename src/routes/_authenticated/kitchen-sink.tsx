      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            A comprehensive showcase of all available UI components in their various states and configurations.
          </p>
        </div>
        ...
        <div className="space-y-24">
          ...
          <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {/* Selection Controls */}
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Selection Controls</h3>
                <div className="space-y-6">
                  <div>
                  ...
                  <div>
                    ...
                    <RadioGroup.Root value={radioValue} onValueChange={(value) => setRadioValue(value as string)}>
          ...
          <section className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Feedback & Progress</h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 mt-1">{Math.round(meterValue * 100)}%</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <NumberField.Root value={numberValue} onValueChange={(value) => setNumberValue(value ?? 0)}>
                      <NumberField.Group className="flex border border-gray-300 rounded-md">
                        <NumberField.Decrement className="px-2 py-1 hover:bg-gray-100 text-sm border-r border-gray-300">-</NumberField.Decrement>
                        <NumberField.Input className="flex-1 px-3 py-2 border-none outline-none" />
                        <NumberField.Increment className="px-2 py-1 hover:bg-gray-100 text-sm border-l border-gray-300">+</NumberField.Increment>
                      </NumberField.Group>
                    </NumberField.Root>
                  </div>
                </div>
          ...
          <section className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Layout & Navigation</h2>
                ...
                <Tabs.Root defaultValue="tab1">
                  ...
                  <Tabs.Panel value="tab1">
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mt-4">
                      <h4 className="font-medium text-gray-900 dark:text-white">Dashboard Content</h4>
                  ...
                  <Tabs.Panel value="tab2">
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mt-4">
                      <h4 className="font-medium text-gray-900 dark:text-white">Analytics Content</h4>
                      <p className="text-gray-600 dark:text-gray-300 mt-2">
                  ...
                  <Tabs.Panel value="tab3">
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mt-4">
                      <h4 className="font-medium text-gray-900 dark:text-white">Settings Content</h4>
                      <p className="text-gray-600 dark:text-gray-300 mt-2">
          ...
          <section className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Overlays & Dialogs</h2>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  <Button onClick={() => setAlertDialogOpen(true)} variant="danger" className="w-full mb-2">
                    Open Alert
                  </Button>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Confirmation dialog
                    ...
                    <Popover.Portal>
                      <Popover.Positioner>
                        <Popover.Popup className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-lg">
                          <h4 className="font-medium text-gray-900 dark:text-white mb-2">Popover Content</h4>
                          <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
                            This is a popover with some content.
                          </p>
                          <Button size="sm" onClick={() => setPopoverOpen(false)}>Close</Button>
                        </Popover.Popup>
                      </Popover.Positioner>
                    </Popover.Portal>
                  </Popover.Root>
          ...
          <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    <Avatar.Root className="w-8 h-8">
                      <Avatar.Image src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face" alt="Small avatar" />
                      <Avatar.Fallback>SM</Avatar.Fallback>
                    </Avatar.Root>
                    <Avatar.Root className="w-12 h-12">
                      <Avatar.Image src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=48&h=48&fit=crop&crop=face" alt="Medium avatar" />
                      <Avatar.Fallback>MD</Avatar.Fallback>
                    </Avatar.Root>
                    <Avatar.Root className="w-16 h-16">
                      <Avatar.Image src="https://images.unsplash.com/photo-1494790108755-2616b612c4d8?w=64&h=64&fit=crop&crop=face" alt="Large avatar" />
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-white mb-3">User Profiles</h4>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <Avatar.Root>
                          <Avatar.Image src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=40&h=40&fit=crop&crop=face" alt="John Doe" />
                      ...
                      <div className="flex items-center space-x-3">
                        <Avatar.Root>
                          <Avatar.Image src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=40&h=40&fit=crop&crop=face" alt="Jane Smith" />
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Preview Cards</h3>
                <div className="space-y-4">
                  <PreviewCard.Root>
                    <PreviewCard.Trigger href="https://example.com" className="block">
                      <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&h=200&fit=crop" alt="Beautiful Landscape" className="w-full h-32 object-cover rounded mb-2" />
                      <h4 className="font-medium text-gray-900 dark:text-white">Beautiful Landscape</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-300">A stunning mountain view with crystal clear lakes</p>
                    </PreviewCard.Trigger>
                    <PreviewCardContent>
                      <div className="p-4">
                        <h4 className="font-medium">Beautiful Landscape</h4>
                        <p className="text-sm text-gray-600 mt-2">A stunning mountain view with crystal clear lakes</p>
                      </div>
                    </PreviewCardContent>
                  </PreviewCard.Root>
                  <PreviewCard.Root>
                    <PreviewCard.Trigger href="https://example.com" className="block">
                      <img src="https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=300&h=200&fit=crop" alt="Modern Architecture" className="w-full h-32 object-cover rounded mb-2" />
                      <h4 className="font-medium text-gray-900 dark:text-white">Modern Architecture</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-300">Innovative building design in the heart of the city</p>
                    </PreviewCard.Trigger>
                    <PreviewCardContent>
                      <div className="p-4">
                        <h4 className="font-medium">Modern Architecture</h4>
                        <p className="text-sm text-gray-600 mt-2">Innovative building design in the heart of the city</p>
                      </div>
                    </PreviewCardContent>
                  </PreviewCard.Root>
                </div>
          ...
          <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Collapsible</h3>
                <Collapsible.Root>
                  <Collapsible.Trigger>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Scroll Area</h3>
                    ...
                    <div className="space-y-3">
                      {Array.from({ length: 20 }, (_, i) => (
                        <div key={i} className="p-3 bg-gray-50 dark:bg-gray-700 rounded">
                          <div className="font-medium text-gray-900 dark:text-white">Item {i + 1}</div>
