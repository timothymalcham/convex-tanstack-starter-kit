...
export function Container({ children, size = "xl", padding = "md", className, as: Component = "div" }: ContainerProps) {
    const sizeClasses = {
        sm: "max-w-screen-sm",
        md: "max-w-screen-md",
        lg: "max-w-screen-lg",
    ...
    return (
        <Component className={twMerge("mx-auto w-full", sizeClasses[size], paddingClasses[padding], className)}>
            {children}
        </Component>
    );
}
...
export function Grid({ children, cols = 1, gap = "md", className, as: Component = "div" }: GridProps) {
    const gapClasses = {
        none: "",
        xs: "gap-1",
        sm: "gap-2",
    ...
    return <Component className={twMerge("grid", colClasses, gapClasses[gap], className)}>{children}</Component>;
}
...
export function Section({
    ...
    return (
        <Component className={twMerge(sizeClasses[size], backgroundClasses[background], className)}>
            {children}
        </Component>
    );
}
...
export function Columns({ children, cols = 2, gap = "md", className }: ColumnsProps) {
    const gapClasses = {
        none: "",
        xs: "gap-1",
        sm: "gap-2",
    ...
    return <div className={twMerge(colClasses, gapClasses[gap], className)}>{children}</div>;
}
...
export function Center({ children, minHeight, className }: CenterProps) {
    ...
    return (
        <div
            className={twMerge("flex items-center justify-center", minHeightClass, className)}
