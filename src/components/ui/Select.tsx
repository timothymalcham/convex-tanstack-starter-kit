...
const SelectValue = React.forwardRef<HTMLSpanElement, SelectValueProps>(({ className, ...props }, ref) => {
    return <BaseSelect.Value ref={ref} className={twMerge("flex-1 text-left truncate", className)} {...props} />;
});
...
const SelectPositioner = React.forwardRef<HTMLDivElement, SelectPositionerProps>(({ className, ...props }, ref) => {
    return <BaseSelect.Positioner ref={ref} className={twMerge("z-50", className)} {...props} />;
});
...
const SelectPopup = React.forwardRef<HTMLDivElement, SelectPopupProps>(({ className, ...props }, ref) => {
    return (
        <BaseSelect.Popup
            ref={ref}
            className={twMerge(
...
const SelectItem = React.forwardRef<HTMLDivElement, SelectItemProps>(({ className, ...props }, ref) => {
    return (
        <BaseSelect.Item
            ref={ref}
            className={twMerge(
...
const SelectGroup = React.forwardRef<HTMLDivElement, SelectGroupProps>(({ className, ...props }, ref) => {
...
const SelectGroupLabel = React.forwardRef<HTMLDivElement, SelectGroupLabelProps>(({ className, ...props }, ref) => {
    return (
        <BaseSelect.GroupLabel
            ref={ref}
            className={twMerge("py-1.5 pl-8 pr-2 text-xs font-semibold text-gray-500 dark:text-gray-400", className)}
            {...props}
        />
    );
});
...
export const SelectContent = React.forwardRef<HTMLDivElement, SelectContentProps>(({ children, className }, ref) => {
    return (
        <SelectPortal>
            <SelectPositioner>
