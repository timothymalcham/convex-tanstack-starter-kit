    ...
    return (
      <div
        ...
        className={twMerge(
          ...
          animate && "before:absolute before:inset-0 before:animate-shimmer before:bg-gradient-to-r before:from-transparent before:via-white/10 before:to-transparent",
          className
        )}
        style={{
...
export function SkeletonCard({
  ...
  return (
    <div
      className={twMerge(
        "rounded-lg border border-border-outline bg-surface-card p-6",
        className
      )}
    >
      {children || (
