...
const MenuBarRoot = React.forwardRef<HTMLDivElement, MenuBarRootProps>(
  ({ className, ...props }, ref) => {
    return (
      <BaseMenubar.Root
        ref={ref}
...
const MenuBarGroup = React.forwardRef<HTMLDivElement, MenuBarGroupProps>(
  ({ className, ...props }, ref) => {
    return (
      <BaseMenubar.Menu.Group
        ref={ref}
        className={className}
        {...props}
      />
...
const MenuBarItemIndicator = React.forwardRef<HTMLSpanElement, MenuBarItemIndicatorProps>(
  ({ className, ...props }, ref) => {
    return (
      <BaseMenubar.Menu.ItemIndicator
        ref={ref}
