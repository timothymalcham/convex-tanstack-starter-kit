...
export function AnimatedSpinner({ size = "md", color = "primary", speed = "normal", className }: AnimatedSpinnerProps) {
    const sizeClasses = {
        xs: "h-3 w-3",
        sm: "h-4 w-4",
        md: "h-6 w-6",
...
export function PulsingDots({ count = 3, size = "md", color = "primary", className }: PulsingDotsProps) {
    const sizeClasses = {
        sm: "h-1.5 w-1.5",
        md: "h-2 w-2",
        lg: "h-3 w-3",
...
export function AnimatedSkeleton({ className, shimmer = true, pulse = false }: AnimatedSkeletonProps) {
...
export function AnimatedProgress({
    ...
    return (
        <div className={`w-full bg-interactive-muted rounded-full h-2 overflow-hidden ${className}`}>
            <motion.div
                className={`h-full bg-interactive-primary rounded-full ${striped ? "bg-stripes" : ""} ${barClassName}`}
                initial={{ width: 0 }}
...
export function LoadingWave({ bars = 5, height = "md", color = "primary", className }: LoadingWaveProps) {
    const heightClasses = {
        sm: "h-4",
        md: "h-6",
        lg: "h-8",
...
export function BreathingCircle({ size = "md", color = "primary", className }: BreathingCircleProps) {
    const sizeClasses = {
        sm: "h-8 w-8",
        md: "h-12 w-12",
        lg: "h-16 w-16",
