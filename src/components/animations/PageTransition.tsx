...
export function PageTransition({ children, variant = "fade", duration, className }: PageTransitionProps) {
    const transition = pageTransitions[variant];

    // Override duration if provided
    const customTransition = duration ? { ...transition.transition, duration } : transition.transition;
 ...
 */
export function RouteTransition({ children, ...props }: PageTransitionProps) {
    return (
