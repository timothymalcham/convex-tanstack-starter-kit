...
export function PinchToZoom({ children, minScale = 0.5, maxScale = 3, className }: PinchToZoomProps) {
...
export function ShakeGesture({ children, onShake, intensity = 10, className }: ShakeGestureProps) {
...
export function FlipCard({ front, back, className, trigger = "click" }: FlipCardProps) {
